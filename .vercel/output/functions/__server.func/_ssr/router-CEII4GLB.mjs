import { e as compileDecodeCharMap, h as createLRUCache, a3 as trimPath, a0 as rewriteBasepath, f as composeRewrites, U as processRouteTree, S as processRouteMasks, $ as resolvePath, d as cleanPath, a5 as trimPathRight, g as createControlledPromise, Q as parseHref, p as executeRewriteInput, C as isDangerousProtocol, W as redirect, I as isRedirect, G as isNotFound, t as findSingleMatch, k as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, c as buildRouteBranch, A as interpolatePath, P as nullReplaceEqualDeep, Y as replaceEqualDeep$1, M as last, j as decodePath, r as findFlatMatch, u as functionalUpdate$1, s as findRouteMatch, H as isPromise, B as invariant, a1 as rootRouteId, a7 as useRouter, L as jsxRuntimeExports, O as Outlet, z as hasKeys, q as executeRewriteOutput, b as arraysEqual, V as reactExports, R as React, o as exactPathTest, X as removeTrailingSlash, F as isModuleNotFoundError, J as isServer$1, l as dummyMatchContext, N as matchContext, n as escapeHtml, E as isInlinableStylesheet, v as getAssetCrossOrigin, a6 as useHydrated, a4 as trimPathLeft, K as joinPaths, _ as resolveManifestAssetLink, m as encodePathLikeUrl, Z as requireReactDom, w as getDefaultExportFromCjs } from "./server-CzXKlo6r.mjs";
...
const appCss = "/assets/styles-CeE-fSKG.css";
...
const Route$3 = createRootRouteWithContext()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,700;1,700&family=Inter:wght@400;500;600;700&display=swap" }
    ]
  }),
...
const $$splitComponentImporter$2 = () => import("./dashboard-CBoookCg.mjs");
...
const $$splitComponentImporter$1 = () => import("./auth-DM2FHLvq.mjs");
const Route$1 = createFileRoute("/auth")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-lLpyWfLz.mjs");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Scannez, jouez et gagnez des bons d'achat et tickets de cinéma. Opération spéciale Fête des Mères avec Peryssac, Kiabi, Gémo, KIKO et Le West."
    }]
  })
});
