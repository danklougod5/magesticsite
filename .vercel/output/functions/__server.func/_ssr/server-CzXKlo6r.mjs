...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DHggvTOk.mjs");
...
const manifest = {
  "0b4255764242db65722e1fc1ee4f3c1f979640a26d3ac0148cc746bdc4a422c2": {
    functionName: "getDashboardData_createServerFn_handler",
    importer: () => import("./spins.functions-ocBeBpK9.mjs")
  },
  "7b9fd446ea00b90d633d202dbd634ccf4cebde29d2733d54ac586ab6c0fb173b": {
    functionName: "checkExisting_createServerFn_handler",
    importer: () => import("./spins.functions-ocBeBpK9.mjs")
  },
  "97f814ff3f671888817aa959f6a2758ea0f10256f5d9784b036dc6ad34b7d412": {
    functionName: "recordSpin_createServerFn_handler",
    importer: () => import("./spins.functions-ocBeBpK9.mjs")
  },
  "d5188315c4ba6fd5c7defb7147cb8e8dbd7d9f8e2fd629a0d1d61ff7c6124682": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CEII4GLB.mjs").then((n2) => n2.g),
    import("./start-ZAsbod5v.mjs"),
